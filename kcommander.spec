...
Summary(pl.UTF-8):	Zarządca plików podobny do Windows Commandera
Name:		kcommander
Version:	3.0
Release:	0.%{_beta}.2
License:	GPL
...
KCommander jest narzędziem służącym do zarządzania plikami,
przeznaczonym dla byłych użytkowników Windows, którzy używali i
